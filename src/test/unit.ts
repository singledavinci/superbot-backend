...
async function runLocalTests() {
    ...
    console.log('\n--- Test 2: Strong Bullish Context ---');
    const bullishReport = engine.analyzeWhaleBuy(
        { address: '0x123', winRate: 0.85, totalFlips: 20, realizedProfit: 10 },
        true,  // First entry
        0.06,  // +6% floor
        -0.10, // -10% listings
    ...
    const riskReport = engine.analyzeWhaleBuy(
        { address: '0x123', winRate: 0.70, totalFlips: 10, realizedProfit: 2 },
