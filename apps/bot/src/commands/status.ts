...
export async function execute(interaction: ChatInputCommandInteraction) {
    ...
    try {
        ...
        const embed = new EmbedBuilder()
            ...
            .addFields(
                { name: '📡 Alert Channels',    value: channelLines,    inline: false },
                { name: '🐳 Tracked Wallets',   value: walletLines,     inline: false },
                { name: '🖼️ Tracked Collections', value: collectionLines, inline: false },
            )
